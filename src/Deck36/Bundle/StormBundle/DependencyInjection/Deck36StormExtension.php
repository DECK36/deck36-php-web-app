...
class Deck36StormExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter(
            'deludedkittenrobbers__badge_name',
            $config['DeludedKittenRobbersBolt']['badge']['name']
        );
        $container->setParameter(
            'deludedkittenrobbers__badge_text',
            $config['DeludedKittenRobbersBolt']['badge']['text']
        );
        $container->setParameter(
            'deludedkittenrobbers__badge_size',
            $config['DeludedKittenRobbersBolt']['badge']['size']
        );
        $container->setParameter(
            'deludedkittenrobbers__badge_color',
            $config['DeludedKittenRobbersBolt']['badge']['color']
        );
        $container->setParameter(
            'deludedkittenrobbers__badge_effect',
            $config['DeludedKittenRobbersBolt']['badge']['effect']
        );
        ...
        $container->setParameter(
            'kittenrobbers__badge_name',
            $config['KittenRobbersFromOuterSpaceBolt']['badge']['name']
        );
        $container->setParameter(
            'kittenrobbers__badge_text',
            $config['KittenRobbersFromOuterSpaceBolt']['badge']['text']
        );
        $container->setParameter(
            'kittenrobbers__badge_size',
            $config['KittenRobbersFromOuterSpaceBolt']['badge']['size']
        );
        $container->setParameter(
            'kittenrobbers__badge_color',
            $config['KittenRobbersFromOuterSpaceBolt']['badge']['color']
        );
        $container->setParameter(
            'kittenrobbers__badge_effect',
            $config['KittenRobbersFromOuterSpaceBolt']['badge']['effect']
        );


        // RaiderOfTheKittenRobbersBolt
        $container->setParameter(
            'raider_of_the_robbers_badge_timewindow',
            $config['RaiderOfTheKittenRobbersBolt']['badge_timewindow']
        );
        $container->setParameter(
            'raider_of_the_robbers_the_chosen_one_timewindow',
            $config['RaiderOfTheKittenRobbersBolt']['the_chosen_one_timewindow']
        );

        $container->setParameter(
            'raider_of_the_robbers__badge_name',
            $config['RaiderOfTheKittenRobbersBolt']['badge']['name']
        );
        $container->setParameter(
            'raider_of_the_robbers__badge_text',
            $config['RaiderOfTheKittenRobbersBolt']['badge']['text']
        );
        $container->setParameter(
            'raider_of_the_robbers__badge_size',
            $config['RaiderOfTheKittenRobbersBolt']['badge']['size']
        );
        $container->setParameter(
            'raider_of_the_robbers__badge_color',
            $config['RaiderOfTheKittenRobbersBolt']['badge']['color']
        );
        $container->setParameter(
            'raider_of_the_robbers__badge_effect',
            $config['RaiderOfTheKittenRobbersBolt']['badge']['effect']
        );
