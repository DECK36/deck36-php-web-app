!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);throw new Error("Cannot find module '"+g+"'")}var j=c[g]={exports:{}};b[g][0].call(j.exports,function(a){var c=b[g][1][a];return e(c?c:a)},j,j.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(){window.clientconfig={localstorage:{namespace:"deck36-plan9"},logger:{level:"DEBUG",appender:"BrowserConsoleAppender",enabled:!0},socketconnect:{connect:{protocol:"https://",host:"api.plan9-dev.deck36.de",port:"443"},playground:{url:"/playground",details:{query:"userId="+USER_ID}},overview:{url:"/overview",details:{query:"userId="+USER_ID}}},useCompression:!1}},{}],2:[function(){clientconfig.logger.enabled=!0,clientconfig.useCompression=!1,clientconfig.socketconnect.connect.host="apiplan9.deck36.de"},{}],3:[function(a,b){(function(a){/*!
 * async
